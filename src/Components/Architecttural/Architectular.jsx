  ...
  return (
    <div className='px-[10px] pt-[64px] md:px-[30px] lg:px-[70px] 2xl:px-[110px]'>
        <div className="controllSection text-center lg:flex items-center justify-between">
            <h1 className='text-[35px] font-golos font-[600] sm:text-center'>Xonadonlarning o‘ylangan rejalari</h1>
        ...
        <div className="imgs flex flex-col items-center mt-[30px] sm:flex-row sm:justify-between">
