...
mashhur o'rtaosiyolik shoir Abdurahmon Jomiy sharafiga atalgan.</p>
                ...
                <div className="headerButtons hidden md:flex  flex flex-col items-center font-golos text-[12.6px] gap-[16px]">
                    <button className='w-[56px] h-[56px]  rounded rounded-[50%] text-white bg-[#384D8B] p-[13px]'><a target='_blank' href="https://www.youtube.com/">Jonli efir</a></button>
                    <button className='w-[56px] h-[56px]  rounded rounded-[50%] text-white bg-[#384D8B] p-[1.3px] flex flex-col items-center justify-center'><a target='_blank' href="https://earth.google.com/web/"><TbWorld className='text-[22px]'/> 360</a></button>
                    <button className='w-[56px] h-[56px]  rounded rounded-[50%] text-white bg-[#384D8B] p-[13px]'><a target='_blank' href="https://zoom.us/"><TbPhoneCall className='text-[20px] sm:text-[24px] m-auto' /></a></button>
                </div>
            </header>
        </div>
    )
