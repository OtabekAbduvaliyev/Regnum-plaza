  ...
  return (
    ...
    >
      <div className="ujeImg">
        <img src={houseImg} alt="" className="2xl:mt-[64px]  2xl:w-[828px] 2xl:h-[560px] 2xl:rounded-se-[280px] 2xl:rounded-[16px] w-[100%] mt-[16px] rounded-se-[120px] lg:rounded-se-[200px] rounded-[8px]  lg:w-[600px] lg:h-[400px] md:w-[324px] md:h-[100%]"/>
      </div>
      <div className="psLocationInf mt-[20px] flex flex-col 2xl:mr-[49px] md:max-w-[324px] lg:max-w-[544px] 2xl:max-w-[686px]">
        ...
        <p className="text-[16px] md:text-[14px] lg:text-[13px] 2xl:text-[18px] text-[#505050] font-golos mt-[16px] 2xl:items-center 2xl:leading-[24px]">
          ...
          Bu yerda yashash ajoyib, biznes bilan shug'ullanish esa qulay <br className="2xl:hidden"/>{" "}
          Transport infratuzilmasi shaharning istalgan nuqtasiga oson yetib
          borish <br className="2xl:hidden"/> imkonini beradi: Siz faqat istagan va zarur
          yo'nalishingizni tanlashingiz kifoya.
        </p>
        <div className="py-[16px] 2xl:py-[24px] bg-[#F3F3EF] pl-[23px] rounded-ss-[64px] lg:rounded-ss-[22px] rounded-r-[32px] mt-[24px] 2xl:mt-[64px] md:hidden lg:flex  2xl:rounded-ss-[32px] 2xl:rounded-[]">
