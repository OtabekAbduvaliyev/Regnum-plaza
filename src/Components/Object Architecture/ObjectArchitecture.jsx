  ...
  return (
    ...
    <div className="flex flex-col-reverse  md:items-center 2xl:pt-[64px] md:pt-[40px] lg:pt-[0px]   md:flex-row md:gap-[40px] lg:gap-[70px]">
      <div className="ujeImg  w-[100%]">
        ...
        <div class="relative w-[100%] items-center max-w-[450px] h-[190px]  md:w-[276px] md:h-[136px] lg:w-[476px] lg:h-[186px] bg-white rounded-[16px] shadow-2xl mt-[-115px] ml-auto md:mr-auto md:ml-[17px] lg:ml-auto lg:mr-[39px] z-999 py-[16px] px-[24px] md:p-[16px] lg:px-[46px] lg:py-[30px] 2xl:w-[100%] 2xl:max-w-[647px] 2xl:h-[248px] 2xl:px-[56px] 2xl:mt-[-180px]">
          <div class="flex  mb-[8px] lg:mb-[16px]">
            <div class="flex items-center justify-center w-10 h-10 2xl:w-14 2xl:h-14 bg-gray-100 rounded-full">
              <svg
          ...
          <p class=" font-golos text-[#000000] mb-[10px] text-[14px] 2xl:leading-[32px] md:text-[12px] lg:text-[17px] md:leading-[20px] leading-[24px] 2xl:text-[24px]">
      ...
      <div className="mt-[227px] sm:mt-[0px] w-[100%]">
        ...
        <p className=" font-golos text-[16px] md:text-[14px] lg:text-[18px] lg:text-black text-[#505050] 2xl:text-[24px] max-w-[654px] 2xl:mt-[24px] font-[460] leading-[24px] 2xl:leading-[32px] mt-[12px] 2xl:max-w-[694px]">
          Majmua mutlaq xavfsiz va erkin hudud sifatida chuqur <br /> o'ylangan. Hech
          ganday begona kishilar va chagirilmagan mehmonlar.
        </p>
        <p className=" font-golos text-[16px] md:text-[14px] text-[#505050] lg:text-[18px] lg:text-black 2xl:text-[24px] max-w-[654px] 2xl:mt-[24px] font-[460] leading-[24px] 2xl:leading-[32px] mt-[10px] 2xl:max-w-[694px]">
          {" "}
        ...
        <div className="icons flex flex-col gap-[10px] 2xl:gap-[88px] mt-[38px] 2xl:mt-[48px] sm:flex-row md:hidden lg:flex lg:justify-between">
          <div className="flex items-center font-[500] text-[24px] gap-[16px] xl:flex-col xl:items-start">
            ...
            />
            <p className="font-[500] text-[14px] lg:text-[18px] text-black font-golos leading-[22px] 2xl:leading-[25px] 2xl:text-[24px] lg:max-w-[130px] 2xl:max-w-[150px]">
          ...
          <div className="flex items-center font-[500] text-[24px] gap-[16px] xl:flex-col xl:items-start ">
            <img
              ...
              className="max-w-[48px] 2xl:max-w-[80px] lg:max-w-[56px]"
            />
            <p className="font-[500] text-[14px] lg:text-[18px] font-golos leading-[22px] 2xl:leading-[25px] 2xl:text-[24px] lg:max-w-[150px] 2xl:max-w-[170px]">
          ...
          <div className="flex items-center font-[500] text-[24px] gap-[16px] xl:flex-col xl:items-start">
            <img
              ...
              className="max-w-[48px] 2xl:max-w-[80px] lg:max-w-[56px]"
            />
            <p className="font-[500] text-[14px] lg:text-[18px] font-golos leading-[22px] 2xl:leading-[25px] 2xl:text-[24px] lg:max-w-[200px] 2xl:max-w-[262px]">
