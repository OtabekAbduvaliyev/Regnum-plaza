...
const Footer = () => {
  return (
    <div className="bg-[#384D8B] text-[white] font-golos" id="contact">
      <div className=" px-[15px] sm:px-[0px]  max-w-[500px] sm:max-w-[650px] md:max-w-[672px] lg:max-w-[1000px] xl:max-w-[1200px] 2xl:max-w-[1680px] py-[30px]  m-auto ">
      <div className="font-golos flex flex-col-reverse md:gap-[24px] md:flex-row justify-between">
        <div className="flex-1 mt-[16px]">
          <h1 className="font-[600] text-[24px] lg:text-[28px] font-golos">Bog‘lanish</h1>
          <div className="location">
            ...
            <p className="text-[14px] mt-[4px] md:text-[12px]">
          ...
          <div className="phoneNumber mt-[32px]">
            ...
            <div className="flex items-center gap-[8px] cursor-pointer hover:text-[#5181B8] transition-all duration-700">
              ...
              <p className="font-[600] text-[28px] lg:text-[24px]"><a href="tel://1066">1066</a></p>
            </div>
          </div>
          ...
          <div className="socialMedia flex gap-[5px] lg:gap-[3px] mt-[32px] md:hidden lg:flex">
            <div className="w-[60px] h-[52px] lg:h-[42px] lg:w-[48px] bg-[#FFFFFF29] rounded-[8px] flex items-center justify-center cursor-pointer hover:bg-[#5181B8] transiton-all duration-700">
              <FaFacebookF className="m-auto  text-[28px] lg:text-[24px]" />
            </div>
            <div className="w-[60px] h-[52px] lg:h-[42px] lg:w-[48px] bg-[#FFFFFF29] rounded-[8px] flex items-center justify-center cursor-pointer  hover:bg-[#5181B8] transiton-all duration-700">
              <FaInstagram className="m-auto  text-[28px] lg:text-[24px]" />
            </div>
            <div className="w-[60px] h-[52px] lg:h-[42px] lg:w-[48px] bg-[#FFFFFF29] rounded-[8px] flex items-center justify-center cursor-pointer  hover:bg-[#5181B8] transiton-all duration-700">
              <BiLogoTelegram className="m-auto  text-[28px] lg:text-[24px]" />
            </div>
            <div className="w-[60px] h-[52px] lg:h-[42px] lg:w-[48px] bg-[#FFFFFF29] rounded-[8px] flex items-center justify-center cursor-pointer  hover:bg-[#5181B8] transiton-all duration-700">
              <FiYoutube className="m-auto  text-[28px] lg:text-[24px]" />
            </div>
          </div>
          <div className="mt-[32px] max-w-[828px] text-[12px] 2xl:text-[16px] leading-[16px] md:hidden lg:flex lg:text-[10px]">
            <p>
