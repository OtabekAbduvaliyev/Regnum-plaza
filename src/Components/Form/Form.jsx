...
const Form = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    if (message == "") {
      swal({
        title: "Muvofaqiyatsizlik!",
        text: "Siz ismingizni kiritmadigingiz!",
        icon: "error",
        button: "Yopish",
      });
    } else if (phoneNumber == "") {
      swal({
        title: "Muvofaqiyatsizlik!",
        text: "Siz telefon raqamingizni kiritmadigingiz!",
        icon: "error",
        button: "Yopish",
      });
    } else {
  ...
  return (
    ...
    >
      <div className="border border-1 xl:gap-x-[64px] rounded rounded-[10px] flex flex-col xl:flex-row xl:items-center  pb-[10px] xl:pb-[0px]">
        <div className="2xl:w-[900px] xl:h-[340px] 2xl:h-[432px] 2xl:max-w-[773px]">
          {" "}
        ...
        <div className="px-[20px] xl:pl-[0px] pb-[10px]">
          ...
          <p className="font-golos font-[400] text-[14px] lg:text-[12px]  mt-[16px] 2xl:text-[18px]">
            Aloqa ma’lumotlaringizni qoldiring va <br className="md:hidden" />{" "}
            menejerimiz loyiha haqida ko’proq qiziqarli{" "}
            <br className="hidden md:flex" /> ma’lumotlar beradi
          </p>
          ...
          <div className="check flex items-center lg:items-start gap-[8px] font-golos mt-[24px] font-[500] ">
            <div className="rounded-[8px]">
              <input
                type="checkbox"
                className="w-[24px] h-[24px] lg:w-[18px] lg:h-[18px] 2xl:w-[24px] 2xl:h-[24px] bg-black rounded-[12px] w-[100%] "
                required
              />
            </div>
            <p className="lg:text-[14px] 2xl:text-[18px]">
